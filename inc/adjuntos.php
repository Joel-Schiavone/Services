...
$getAdjuntosByAdjIdRelacionA     = $adjuntos->getAdjuntosByAdjIdRelacion($adj_idRelacion, $adj_tablaRelacion);
...
if (@$opcionAgregar=="si") 
{
	...
	echo "<hr><h4 class='modal-title' id='myModalLabel'>Agregar Adjuntos</h4>";

                                                  echo "<form class='form-horizontal' action='insert-adjunto.php' method='POST' enctype='multipart/form-data'>";
                                                    echo "<div class='form-group'>
                                                                  <div style='margin: 30px;' class='input-group'>
                                                                    ...
                                                                    <input id='icon_prefixB' aria-describedby='basic-addon1'  type='text'  name='adj_desc'   class='form-control' autocomplete='off' required placeholder='Nombre del nuevo archivo'>
                                                                  </div>
                                                                ";
                                                     echo "<div style='margin: 30px;' class='input-group'>
                                                                    <span class='input-group-addon' id='basic-addon1'>
                                                                      <i style='height: 5px; margin-top: -12px;' class='material-icons'>
                                                                        attach_file
                                                                      </i>
                                                                    </span>
                                                                    <input id='icon_prefixB' aria-describedby='basic-addon1' name='adj_ruta' type='file' class='form-control' required>
                                                                  </div>
                                                                ";

                                                                echo "
                                                                  <div style='margin: 30px;' class='input-group'>
                                                                  <button type='submit' class='btn btn-success' name='cargarAdjunto' value='cargarAdjunto' id='cargarAdjunto' style='width: 100%; text-align: center;'><i class='material-icons' style='vertical-align: middle;'> add </i> Agregar Nuevo Archivo adjunto</button>
                                                                   </div>
                                                                </div>";
}
echo "<h4 class='modal-title' id='myModalLabel'>Adjuntos</h4>";
                                                      ...
                                                      echo "<table class='table table-condensed table-hover table-striped'>";
                                                        echo "<tr>";
                                                          ...
                                                          echo "</td>";
                                                        echo "</tr>";
                                                            echo "<input hidden name='id' value='" . $adj_idRelacion . "'></input>";
                                                            echo "<input hidden name='adj_fecha' value='".$adj_fecha."'></input>";
                                                            echo "<input hidden name='ID_usu' value='".$ID_usu."'></input>";
                                                            echo "<input hidden name='adj_idRelacion' value='".$adj_idRelacion."'></input>";
                                                            echo "<input hidden name='adj_tablaRelacion' value='".$adj_tablaRelacion."'></input>";
                                                         echo "</form>";                     
                                                        ...
                                                        echo "<tr>"; 
                                                            ...
                                                            echo "</td>";   
                                                            echo "<td>";
                                                            echo "<input hidden name='id' value='".$adj_idRelacion."'></input><input hidden name='ID_adj' value='".$assoc_getAdjuntosByAdjIdRelacion['ID_adj']."'></input>";
