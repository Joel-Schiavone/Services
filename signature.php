...
<?php
  $ID_ser          = round(12*((base64_decode($_GET['id']))/12344), 0);
...
<div style="width:100%;">
 <form action="registro_firma_cierre_guarda.php"  method="post" enctype="multipart/form-data">
 <textarea hidden type='text' name='firma' id='input'></textarea>
  <input hidden type='text' name='ID_ser' value='<?php echo $assoc_registro_servicio_id['ID_ser'];?>'/>
