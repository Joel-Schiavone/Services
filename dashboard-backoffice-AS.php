...
<!--Fin Cambia de color la solapa si los registros son diferentes de cero-->
  <script type="text/javascript">
    ...
    $('#inicio').ajaxStart(function() {
     $('#cargandoBoton').show();
  

    });
    $('#inicio').ajaxSuccess(function() {
     $('#cargandoBoton').hiden();
    });
...
<!-- INICIO SOLAPA PRINCIPAL-->
  ...
  <!-- Inicio div Asignados -->
    ...
    <?php
      ...
      @$UrlDeRetorno            = "dashboard-backoffice-AS.php"; //Url a la que se debe redireccionar luego de ejecutar la funcion
      include('../inc/barraDeBusqueda2.php');  
    ?>
   <!--FIN: BARRA DE BUSQUEDA-->
      ...
      <h4><i class="material-icons">account_circle</i> Asignados (<a id='viendoResultadosAsignado'> </a> de <?php echo $num_getQuotationsInserted;?>) </h4>
    <?php 
     ...
     <hr class='negra'>
      ...
      <table class='table table-condensed table-hover table-striped'>
        ...
        <tbody id='myTable'>
          ...
          <tfoot>
            <tr>
                <input hidden type="text" name="InicioGetRegistroServicio<?php echo $determinanteDeColumnaAsignado;?>" id="Inicio<?php echo $determinanteDeColumnaAsignado;?>" value="6">
...
<!-- Inicio div Aceptados -->
 ...
 <h4><i class="material-icons">assignment_turned_in</i> Aceptados (<a id='viendoResultadosAccepted'> </a> de <?php echo $num_getQuotationsAccepted?>) </h4>
     ...
     ?>
      ...
      <table class='table table-condensed table-hover table-striped'>
        ...
        <tbody id='myTable'>
          ...
          <tfoot>
            <tr>
               <input hidden type="text" name="InicioGetRegistroServicio<?php echo $determinanteDeColumnaAccepted;?>" id="Inicio<?php echo $determinanteDeColumnaAccepted;?>" value="6">
   ...
   <!-- Inicio div Presupuestados -->
      ...
      <hr>
      <!--Fin Barra de herramientas de ventana-->
      <h4><i class="material-icons">description</i> Presup. (<a id='viendoResultadosPresupuestados'> </a> de <?php echo $num_getQuotationsBudgeted;?>)</h4>
      <?php
    ...
    <div class='table-responsive'>
      <table class='table table-condensed table-hover table-striped'>
        ...
        <tbody id='myTable'>
          ...
          <tfoot>
            <tr>
                <input hidden type="text" name="InicioGetRegistroServicio<?php echo $determinanteDeColumnaPresupuestados;?>" id="Inicio<?php echo $determinanteDeColumnaPresupuestados;?>" value="6">
    ...
    <h4><i class="material-icons">local_shipping</i> Despacho (<a id='viendoResultadosDespacho'> </a> de <?php echo $num_getQuotationsDespacho;?>)</h4>
     <?php
     ...
     <div class='table-responsive'>
      ...
      <tr>
        ...
        <tbody id='myTable'>
          ...
          <tfoot>
            <tr>
               <input hidden type="text" name="InicioGetRegistroServicio<?php echo $determinanteDeColumnaDespacho;?>" id="Inicio<?php echo $determinanteDeColumnaDespacho;?>" value="6">
    ...
    <h4><i class="material-icons">build</i> Instalación (<a id='viendoResultadosInstalacion'> </a> de <?php echo $num_getQuotationsInstalacion;?>)</h4>
     ...
     <div class='table-responsive'>
      <table class='table table-condensed table-hover table-striped'>
        ...
        <tbody id='myTable'>
          ...
          <tfoot>
            <tr>
              <input hidden type="text" name="InicioGetRegistroServicio<?php echo $determinanteDeColumnaInstalacion;?>" id="Inicio<?php echo $determinanteDeColumnaInstalacion;?>" value="6">
    ...
    <div class="col-md-2" id="ExpandirCierre">
      ...
      <hr>
      <!--Fin Barra de herramientas de ventana-->
    <h4 id='asignadosCantidadViendo'><i class="material-icons">lock</i> Cerrados  (<a id='viendoResultadosCierre'> </a> de <?php echo $num_getQuotationsCierreAS;?>) </h4>
      <?php
    ...
    <div class='table-responsive'>
      <table class='table table-condensed table-hover table-striped'>
        ...
        <tbody id='myTable'>
          ...
          <tfoot>
            <tr>
               <input hidden type="text" name="InicioGetRegistroServicio<?php echo $determinanteDeColumnaCierreAS;?>" id="Inicio<?php echo $determinanteDeColumnaCierreAS;?>" value="6">
           ...
           else
           {
            ...
            <div id='collapse".$assoc_getQuotationsRechazado['ID_pto']."' class='panel-collapse collapse in' role='tabpanel' aria-labelledby='headingOne'>
              <div class='panel-body'>
               ...
               <p><i class='material-icons' style='vertical-align: middle'>store</i> <strong>Cliente:</strong> <a href='../MasterData/modify-customer.php?id=".base64_encode((12344*($assoc_getQuotationsRechazado['ID_cli']))/12)."' data-toggle='modal' title='Ver Cliente' target='_blank' data-placement='top'>".$assoc_getQuotationsRechazado['cli_desc']."</a></p>";
         ...
         <div style="margin: 5px;  width: 150px;">
              ...
              <?php 
                 ...
                 for ($usu=0; $usu < $num_getQuotationsUsuarios; $usu++)
                  { 
                   ...
                   echo "<option value='".$assoc_getQuotationsUsuarios['ID_usu']."'>".$assoc_getQuotationsUsuarios['usu_apellido']." ".$assoc_getQuotationsUsuarios['usu_nombre']."</option>";
                  }
               ?>  
             </select> 
          </div>
          ...
          <div class='filasFiltros' name='formulario_asignado' class='formulario_asignado' id='formulario_asignado'>
             ...
             <select class='form-control' name='filtro_asignado' id='filtro_asignado'>
               ...
               <?php 
                 $getQuotationsUsuariosB = $quotations->getQuotationsAsignadosHistorialAS();
                 ...
                 for ($usuB=0; $usuB < $num_getQuotationsUsuariosB; $usuB++)
                  { 
                   ...
                   echo "<option value='".$assoc_getQuotationsUsuariosB['pto_asignado']."'>".$assoc_getQuotationsUsuariosB['usu_apellido']." ".$assoc_getQuotationsUsuariosB['usu_nombre']."</option>";
                  }
               ?>  
             </select> 
          </div>
           ...
           else
           {
            ...
            <div id='collapse".$assoc_getQuotationsOtros['ID_pto']."' class='panel-collapse collapse in' role='tabpanel' aria-labelledby='headingOne'>
              <div class='panel-body'>
               ...
               <p><i class='material-icons' style='vertical-align: middle'>store</i> <strong>Cliente:</strong> <a href='../MasterData/modify-customer.php?id=".base64_encode((12344*($assoc_getQuotationsOtros['ID_cli']))/12)."' data-toggle='modal' title='Ver Cliente' target='_blank' data-placement='top'>".$assoc_getQuotationsOtros['cli_desc']."</a></p>";
...
<?php 
    ...
    else
    {
      ...
      //TRAE LOS 10 PRIMEROS ASIGNADOS
        echo "<script> var total".$determinanteDeColumnaAsignado."=6; $(botonFiltro).click(function()
            {  
             

               var filtro_clienteAsignados=$('#filtro_clienteAsignados').val();
               var filtro_clienteBuscador=$('#filtro_clienteBuscador').val();
               var filtro_tiendaBuscador=$('#filtro_tiendaBuscador').val();
              ...
              var dataString".$determinanteDeColumnaAsignado." = 'filtro_clienteAsignados='+filtro_clienteAsignados + '&action='+action".$determinanteDeColumnaAsignado."  +
               '&filtro_clienteBuscador='+filtro_clienteBuscador + 
               '&filtro_tiendaBuscador='+filtro_tiendaBuscador + 
               '&codigo='+codigo +
               '&inicio".$determinanteDeColumnaAsignado."='+inicio".$determinanteDeColumnaAsignado." ;

                      $('#cargandoBotonGeneral').fadeIn(500);
              ...
              $.ajax( 
              {
                  ...
                  type: 'POST',
                  url: 'ResultadosDeColumnasAS.php',
                  ...
                  success: function(data)
                   {
                     ...
                     {
                       $('#MasGetRegistroServicio".$determinanteDeColumnaAsignado."').toggle('fast');
                     }

                     $('#resultados".$determinanteDeColumnaAsignado."').toggle('fast').toggle('fast').html(data);
                     ...
                     $('#Inicio".$determinanteDeColumnaAsignado."').val(total".$determinanteDeColumnaAsignado.");
                         ...
                         $('#cargandoBotonGeneral').fadeOut(500);
            ...
            //TRAE 10 ASIGNADOS MAS
     echo "<script> var total".$determinanteDeColumnaAsignado."=6; $('#MasGetRegistroServicio".$determinanteDeColumnaAsignado."').click(function()
            {  
                  ...
                  success: function(data)
                   {
                     ...
                     $('#resultados".$determinanteDeColumnaAsignado."').fadeIn(500).html(data);
                      total".$determinanteDeColumnaAsignado."= (parseInt(inicio".$determinanteDeColumnaAsignado.") + parseInt(total".$determinanteDeColumnaAsignado."));
                     $('#Inicio".$determinanteDeColumnaAsignado."').val(total".$determinanteDeColumnaAsignado.");
           ...
           //TRAE LOS 10 PRIMEROS ACEPTADOS
              echo "<script> var total".$determinanteDeColumnaAccepted."=6; $(botonFiltro).click(function()
            {  
                var filtro_clienteAsignados=$('#filtro_clienteAsignados').val();
               var filtro_clienteBuscador=$('#filtro_clienteBuscador').val();
               var filtro_tiendaBuscador=$('#filtro_tiendaBuscador').val();
              ...
              var dataString".$determinanteDeColumnaAccepted." = 'filtro_clienteAsignados='+filtro_clienteAsignados + '&action='+action".$determinanteDeColumnaAccepted."  +
               '&filtro_clienteBuscador='+filtro_clienteBuscador + 
               '&filtro_tiendaBuscador='+filtro_tiendaBuscador + 
               '&codigo='+codigo +
               '&inicio".$determinanteDeColumnaAccepted."='+inicio".$determinanteDeColumnaAccepted." ;
                  ...
                  success: function(data)
                   {
                     ...
                     {
                       $('#MasGetRegistroServicio".$determinanteDeColumnaAccepted."').toggle('fast');
                     }

                     $('#resultados".$determinanteDeColumnaAccepted."').toggle('fast').toggle('fast').html(data);
           ...
           //TRAE 10 ASIGNADOS MAS
     echo "<script> var total".$determinanteDeColumnaAccepted."=6; $('#MasGetRegistroServicio".$determinanteDeColumnaAccepted."').click(function()
            {  
                var filtro_clienteAsignados=$('#filtro_clienteAsignados').val();
               var filtro_clienteBuscador=$('#filtro_clienteBuscador').val();
               var filtro_tiendaBuscador=$('#filtro_tiendaBuscador').val();
                  ...
                  success: function(data)
                   {
                     ...
                     $('#resultados".$determinanteDeColumnaAccepted."').fadeIn(500).html(data);
                      total".$determinanteDeColumnaAccepted."= (parseInt(inicio".$determinanteDeColumnaAccepted.") + parseInt(total".$determinanteDeColumnaAccepted."));
                     $('#Inicio".$determinanteDeColumnaAccepted."').val(total".$determinanteDeColumnaAccepted.");
           ...
           //TRAE LOS 10 PRIMEROS PRESUPUESTADOS
                         echo "<script> var total".$determinanteDeColumnaPresupuestados."=6; $(botonFiltro).click(function()
            {  
                var filtro_clienteAsignados=$('#filtro_clienteAsignados').val();
               var filtro_clienteBuscador=$('#filtro_clienteBuscador').val();
               var filtro_tiendaBuscador=$('#filtro_tiendaBuscador').val();
              ...
              var dataString".$determinanteDeColumnaPresupuestados." = 'filtro_clienteAsignados='+filtro_clienteAsignados + '&action='+action".$determinanteDeColumnaPresupuestados."  +
               '&filtro_clienteBuscador='+filtro_clienteBuscador + 
               '&filtro_tiendaBuscador='+filtro_tiendaBuscador + 
               '&codigo='+codigo +
               '&inicio".$determinanteDeColumnaPresupuestados."='+inicio".$determinanteDeColumnaPresupuestados." ;
                  ...
                  success: function(data)
                   {
                     ...
                     {
                       $('#MasGetRegistroServicio".$determinanteDeColumnaPresupuestados."').toggle('fast');
                     }

                     $('#resultados".$determinanteDeColumnaPresupuestados."').toggle('fast').toggle('fast').html(data);
           ...
           //TRAE 10 PRESUPUESTADOS MAS
     echo "<script> var total".$determinanteDeColumnaPresupuestados."=6; $('#MasGetRegistroServicio".$determinanteDeColumnaPresupuestados."').click(function()
            {  
                var filtro_clienteAsignados=$('#filtro_clienteAsignados').val();
               var filtro_clienteBuscador=$('#filtro_clienteBuscador').val();
               var filtro_tiendaBuscador=$('#filtro_tiendaBuscador').val();
                  ...
                  success: function(data)
                   {
                     ...
                     $('#resultados".$determinanteDeColumnaPresupuestados."').fadeIn(500).html(data);
                      total".$determinanteDeColumnaPresupuestados."= (parseInt(inicio".$determinanteDeColumnaPresupuestados.") + parseInt(total".$determinanteDeColumnaPresupuestados."));
                     $('#Inicio".$determinanteDeColumnaPresupuestados."').val(total".$determinanteDeColumnaPresupuestados.");
           ...
           //TRAE LOS 10 PRIMEROS PARA DESPACHO
            echo "<script> var total".$determinanteDeColumnaDespacho."=6; $(botonFiltro).click(function()
            {  
              ...
              var inicio".$determinanteDeColumnaDespacho." = $('input:text[name=InicioGetRegistroServicio".$determinanteDeColumnaDespacho."]').val();
                ...
                var dataString".$determinanteDeColumnaDespacho." = 'filtro_clienteAsignados='+filtro_clienteAsignados + '&action='+action".$determinanteDeColumnaDespacho."  +
               '&filtro_clienteBuscador='+filtro_clienteBuscador + 
               '&filtro_tiendaBuscador='+filtro_tiendaBuscador + 
               '&codigo='+codigo +
               '&inicio".$determinanteDeColumnaDespacho."='+inicio".$determinanteDeColumnaDespacho." ;
                  ...
                  success: function(data)
                   {
                     ...
                     {
                       $('#MasGetRegistroServicio".$determinanteDeColumnaDespacho."').toggle('fast');
                     }

                     $('#resultados".$determinanteDeColumnaDespacho."').toggle('fast').toggle('fast').html(data);
           ...
           //TRAE 10 MAS PARA DESPACHO
     echo "<script> var total".$determinanteDeColumnaDespacho."=6; $('#MasGetRegistroServicio".$determinanteDeColumnaDespacho."').click(function()
            {  
                  ...
                  success: function(data)
                   {
                     ...
                     $('#resultados".$determinanteDeColumnaDespacho."').fadeIn(500).html(data);
                      total".$determinanteDeColumnaDespacho."= (parseInt(inicio".$determinanteDeColumnaDespacho.") + parseInt(total".$determinanteDeColumnaDespacho."));
                     $('#Inicio".$determinanteDeColumnaDespacho."').val(total".$determinanteDeColumnaDespacho.");
           ...
           //TRAE LOS 10 PRIMEROS PARA INSTALACION
            echo "<script> var total".$determinanteDeColumnaInstalacion."=6; $(botonFiltro).click(function()
            {  
                var filtro_clienteAsignados=$('#filtro_clienteAsignados').val();
               var filtro_clienteBuscador=$('#filtro_clienteBuscador').val();
               var filtro_tiendaBuscador=$('#filtro_tiendaBuscador').val();
              ...
              var inicio".$determinanteDeColumnaInstalacion." = $('input:text[name=InicioGetRegistroServicio".$determinanteDeColumnaInstalacion."]').val();
                ...
                var dataString".$determinanteDeColumnaInstalacion." = 'filtro_clienteAsignados='+filtro_clienteAsignados + '&action='+action".$determinanteDeColumnaInstalacion."  +
               '&filtro_clienteBuscador='+filtro_clienteBuscador + 
               '&filtro_tiendaBuscador='+filtro_tiendaBuscador + 
               '&codigo='+codigo +
               '&inicio".$determinanteDeColumnaInstalacion."='+inicio".$determinanteDeColumnaInstalacion." ;
                  ...
                  success: function(data)
                   {
                     ...
                     {
                       $('#MasGetRegistroServicio".$determinanteDeColumnaInstalacion."').toggle('fast');
                     }

                     $('#resultados".$determinanteDeColumnaInstalacion."').toggle('fast').toggle('fast').html(data);
           ...
           //TRAE 10 MAS PARA INSTALACION
     echo "<script> var total".$determinanteDeColumnaInstalacion."=6; $('#MasGetRegistroServicio".$determinanteDeColumnaInstalacion."').click(function()
            {  
              var filtro_clienteAsignados=$('#filtro_clienteAsignados').val();
               var filtro_clienteBuscador=$('#filtro_clienteBuscador').val();
               var filtro_tiendaBuscador=$('#filtro_tiendaBuscador').val();
                  ...
                  success: function(data)
                   {
                     ...
                     $('#resultados".$determinanteDeColumnaInstalacion."').fadeIn(500).html(data);
                      total".$determinanteDeColumnaInstalacion."= (parseInt(inicio".$determinanteDeColumnaInstalacion.") + parseInt(total".$determinanteDeColumnaInstalacion."));
                     $('#Inicio".$determinanteDeColumnaInstalacion."').val(total".$determinanteDeColumnaInstalacion.");
           ...
           //TRAE LOS 10 PRIMEROS CERRADOS
            echo "<script> var total".$determinanteDeColumnaCierreAS."=6; $(botonFiltro).click(function()
            {  
                var filtro_clienteAsignados=$('#filtro_clienteAsignados').val();
               var filtro_clienteBuscador=$('#filtro_clienteBuscador').val();
               var filtro_tiendaBuscador=$('#filtro_tiendaBuscador').val();
              ...
              var inicio".$determinanteDeColumnaCierreAS." = $('input:text[name=InicioGetRegistroServicio".$determinanteDeColumnaCierreAS."]').val();
                ...
                var dataString".$determinanteDeColumnaCierreAS." = 'filtro_clienteAsignados='+filtro_clienteAsignados + '&action='+action".$determinanteDeColumnaCierreAS."  +
               '&filtro_clienteBuscador='+filtro_clienteBuscador + 
               '&filtro_tiendaBuscador='+filtro_tiendaBuscador + 
               '&codigo='+codigo +
               '&inicio".$determinanteDeColumnaCierreAS."='+inicio".$determinanteDeColumnaCierreAS." ;
                  ...
                  success: function(data)
                   {
                     ...
                     {
                       $('#MasGetRegistroServicio".$determinanteDeColumnaCierreAS."').toggle('fast');
                     }

                     $('#resultados".$determinanteDeColumnaCierreAS."').toggle('fast').toggle('fast').html(data);
           ...
           //TRAE 10 MAS PARA CIERRE
     echo "<script> var total".$determinanteDeColumnaCierreAS."=6; $('#MasGetRegistroServicio".$determinanteDeColumnaCierreAS."').click(function()
            {  
                  ...
                  success: function(data)
                   {
                     ...
                     $('#resultados".$determinanteDeColumnaCierreAS."').fadeIn(500).html(data);
                      total".$determinanteDeColumnaCierreAS."= (parseInt(inicio".$determinanteDeColumnaCierreAS.") + parseInt(total".$determinanteDeColumnaCierreAS."));
                     $('#Inicio".$determinanteDeColumnaCierreAS."').val(total".$determinanteDeColumnaCierreAS.");
