...
if (@$codigo) 
{
         $sql = "SELECT * FROM registro_servicio WHERE ser_cod='".$codigo."'";
...
else
{
  ...
  if($contD==1)
  {
   ...
   //  echo "SELECT * FROM registro_servicio ".$where." ".$filtro_cliente."  ".$filtro_tienda." ".$filtro_estado."  ".$filtro_prioridad."  ".$filtro_asignado."   ";

        $sql = "SELECT * FROM registro_servicio ".$where."  ser_asig=".$ID_usu." AND ".$filtro_cliente."  ".$filtro_tienda." ".$filtro_estado."  ".$filtro_prioridad."  ".$filtro_asignado."  ";
        $result = mysql_query($sql);
        $num_result = mysql_num_rows($result);
    ...
    else
    {
        $where = "WHERE";
         $sql = "SELECT *
              FROM registro_servicio ".$where." ser_asig=".$ID_usu."";
        $result = mysql_query($sql);
        $num_result = mysql_num_rows($result);
    }
