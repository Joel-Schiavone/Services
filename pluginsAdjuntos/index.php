...
<html lang="en">
  <head>
	...
	$images2= "SELECT * from adjuntos WHERE adj_idRelacion='".$adj_idRelacion."' AND adj_tablaRelacion='".$adj_tablaRelacion."'";
	$result		=	mysql_query($images2);
